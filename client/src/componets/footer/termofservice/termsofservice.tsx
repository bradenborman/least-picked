...
require("./termsofservice.scss");

export interface ITermsOfServiceProps {}

export const TermsOfService: React.FC<ITermsOfServiceProps> = (
  props: ITermsOfServiceProps
) => {
   return (
    <div className="terms-of-service-wrapper">
<h1>Terms and Conditions</h1>

<p>Last updated: April 05, 2020</p>
...
<ul>
      ...
      <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Least Picked.</li>
  ...
  <li><strong>Website</strong> refers to Least Picked, accessible from https://least-picked.herokuapp.com/</li>    <li><strong>You</strong> means the individual accessing or using the Service, or the company, or other legal entity on behalf of which such individual is accessing or using the Service, as applicable.</li>
</ul>
...
<ul>
        <li>By email: bradenborman@hotmail.com</li>
            <li>By phone number: 5738261903</li>
    </ul>    
    </div>
  );
